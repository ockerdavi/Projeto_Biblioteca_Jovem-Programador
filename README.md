# Projeto-Biblioteca // Jovem-Programador
1. Biblioteca Jovem Programador
...
JS: Interatividade e comunicação com a API
...
--> Passo 4: Acessar o sistema após iniciar a aplicação, acessar:
